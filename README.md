...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fps-uvicorn-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13955&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fps-uvicorn-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fps-uvicorn` can be installed with:

```
conda install fps-uvicorn
```

It is possible to list all of the versions of `fps-uvicorn` available on your platform with:
